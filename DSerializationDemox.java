...
//Serialization = 	The process of converting an object into a byte stream.
	   ...
	   // important notes	1. children classes of a parent class that implements Serializable will do so 
	   //as well
	   //					2. static fields are not serialized (they belong to the class, not an individual 
	   //object)
...
public class DSerializationDemox {
   ...
   public static void main(String [] args) {
      ...
      FileInputStream fileIn;
		try {
			fileIn = new FileInputStream("instagram.ser");
      ...
      //get the serialVersionUID of the class
	  System.out.println("serialVersionUID: "+serialVersionUID);
	      
      System.out.println("name: " + user.name);
      System.out.println("password: " + user.password);
      System.out.println("SecurityQuestion: " + user.Securityquestion);
